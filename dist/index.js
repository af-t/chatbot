 ...
 * @public
 */
let GoogleGenerativeAIAbortError$1 = class GoogleGenerativeAIAbortError extends GoogleGenerativeAIError$1 {
};
 ...
 */
const PACKAGE_VERSION$1 = "0.24.0";
...
function handleResponseError$1(e, url) {
    ...
    if (err.name === "AbortError") {
        err = new GoogleGenerativeAIAbortError$1(`Request aborted when fetching ${url.toString()}: ${e.message}`);
        err.stack = e.stack;
    }
    else if (!(e instanceof GoogleGenerativeAIFetchError$1 ||
        ...
        start(controller) {
            ...
            function pump() {
                return reader
                    ...
                    err.stack = e.stack;
                    if (err.name === "AbortError") {
                        err = new GoogleGenerativeAIAbortError$1("Request aborted when reading from the stream");
                    }
                    else {
                        err = new GoogleGenerativeAIError$1("Error reading from the stream");
                    }
                    throw err;
                });
            }
...
export { ChatBot, SUPPORTED_MIME_TYPES, ChatBot as default, emojis };
